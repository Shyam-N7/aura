...
// Same get/set/subscribe shape as lib/consent.js.
...
export const QUALITIES = [
  ...
  { id: 'normal', bitrate: 160, label: 'normal', caption: 'balanced · 160 kbps' },
...
export function setAudioQuality(id) {
  ...
  try { localStorage.setItem(KEY, id); } catch { /* localStorage disabled — non-fatal */ }
