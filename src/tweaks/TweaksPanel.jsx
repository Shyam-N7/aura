...
export function TweaksPanel({ title = 'Tweaks', noDeckControls = false, children }) {
  ...
  // reflects reality across reloads. Authors who want custom placement can
  // post the message directly and pass noDeckControls to suppress this one.
  ...
  const [railVisible, setRailVisible] = useState(() => {
    try { return localStorage.getItem('deck-stage.railVisible') !== '0'; } catch (_e) { return true; }
  });
  const toggleRail = (on) => {
    setRailVisible(on);
